      ...
      {STEPS.map((label, i) => {
        ...
        return (
          <div key={label} className="flex flex-1 items-center last:flex-none">
            <div className="flex flex-col items-center gap-2">
              <div
                className={cn(
                  ...
                  isDone && "bg-gold-700 text-white",
                  isActive && !isDone && "bg-gold-700 text-white",
              ...
              <span
                className={cn(
                  ...
                  isDone || isActive ? "text-gold-700" : "text-slate-400"
                )}
              >
                {label}
              </span>
            ...
            {index !== STEPS.length && (
              <div className={cn("mx-2 h-0.5 flex-1 sm:mx-3 sm:mb-5", isDone ? "bg-gold-600" : "bg-slate-200")} />
            )}
          </div>
        );
      })}
